...
class VoiceStateManager:
    ...
    def __init__(self, client: DiscordClientAsync):
        ...
        self.event_voice_channel_changed: EventDispenser[Tuple[str, str, str]] = EventDispenser(client.event_loop)
    ...
    def _on_voice_state_update(self, event_data: dict):
        ...
        self.event_voice_channel_changed.put((user_id, old_channel_id, new_channel_id))